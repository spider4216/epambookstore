...
function BasketClass() {
	...
	var addBasketHandler = function(element) {
		...
		ajaxHelperMethod("/ajax/add-to-basket.html", "post", { id : productId, count : productCount }, element);
	}
	...
	var clearBasketHandler = function(element) {
		ajaxHelperMethod("/ajax/clear-basket.html", "post", null, element);
	}
	...
	var deleteItemBasketHandler = function(element) {
		...
		ajaxHelperMethod("/ajax/delete-book-from-basket.html", "get", {id: id}, element);
	}
	...
	var orderBasketHandler = function(element) {
		ajaxHelperMethod("/ajax/order-books.html", "post", null, element);
	}
